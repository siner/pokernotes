...
STRIPE_PRO_PRICE_ID_MONTHLY=  # €4.99/mo recurring price (set in Cloudflare Pages env, not wrangler.toml)
STRIPE_PRO_PRICE_ID_YEARLY=   # €44.99/yr recurring price (~25% off)
