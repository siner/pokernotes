...
interface CloudflareEnv {
  ...
  /** Stripe Pro Price ID — monthly billing (€4.99/mo). Set via Cloudflare Pages env, not wrangler.toml. */
  STRIPE_PRO_PRICE_ID_MONTHLY: string;
  /** Stripe Pro Price ID — yearly billing (€44.99/yr, ~25% off). Set via Cloudflare Pages env, not wrangler.toml. */
