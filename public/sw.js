(() => {
  ...
  let e,
    ...
    r = {
      getRuntimeName: (e) => {
        let t;
        return (
          e || ((t = s.runtime), [s.prefix, t, s.suffix].filter((e) => e && e.length > 0).join('-'))
        );
      },
    };
  ...
  function g(a) {
    ...
    let s = (function (a) {
      if ('function' == typeof a)
        return (
          ...
          ? function (...e) {
              return (a.apply(y(this), e), g(this.request));
            }
          : function (...e) {
              return g(a.apply(y(this), e));
            };
    ...
    return (s !== a && (m.set(a, s), w.set(s, a)), s);
  }
  let y = (e) => w.get(e);
  function _(e, t, { blocked: a, upgrade: s, blocking: r, terminated: i } = {}) {
    let n = indexedDB.open(e, t),
      c = g(n);
    return (
      s &&
        n.addEventListener('upgradeneeded', (e) => {
          s(g(n.result), e.oldVersion, e.newVersion, g(n.transaction), e);
        }),
  ...
  function R(e, t) {
    ...
    let a = t.replace(/FromIndex$/, ''),
      s = t !== a,
      r = v.includes(a);
    if (!(a in (s ? IDBIndex : IDBObjectStore).prototype) || !(r || b.includes(a))) return;
  ...
  p = ((e) => ({
    ...e,
    get: (t, a, s) => R(t, a) || e.get(t, a, s),
    has: (t, a) => !!R(t, a) || e.has(t, a),
  }))(p);
  let E = ['continue', 'continuePrimaryKey', 'advance'],
    q = {},
    S = new WeakMap(),
    C = new WeakMap(),
    D = {
  ...
  async function* k(...e) {
    ...
    let a = new Proxy(t, D);
    for (C.set(a, t), w.set(a, y(t)); t; )
      (yield a, (t = await (S.get(a) || t.continue())), S.delete(a));
  }
  function P(e, t) {
    return (
      (t === Symbol.asyncIterator && d(e, [IDBIndex, IDBObjectStore, IDBCursor])) ||
      ('iterate' === t && d(e, [IDBIndex, IDBObjectStore]))
    );
  }
  p = ((e) => ({
    ...e,
    get: (t, a, s) => (P(t, a) ? k : e.get(t, a, s)),
    has: (t, a) => P(t, a) || e.has(t, a),
  }))(p);
  let N = {
  ...
  class A {
    ...
    async cachePut(e, t) {
      ...
      let { cacheName: c, matchOptions: o } = this._strategy,
        ...
        f = d ? await l(h, s.clone(), ['__WB_REVISION__'], o) : null;
      try {
        await h.put(s, d ? r.clone() : r);
      } catch (e) {
    ...
    async getCacheKey(e, t) {
      ...
      if (!this._cacheKeys[a]) {
        ...
        for (let e of this.iterateCallbacks('cacheKeyWillBeUsed'))
          s = T(await e({ mode: t, request: s, event: this.event, params: this.params }));
        this._cacheKeys[a] = s;
      }
      ...
      try {
        ...
        if (r instanceof Error) {
          for (let i of e.iterateCallbacks('handlerDidError'))
            if (void 0 !== (s = await i({ error: r, event: a, request: t }))) break;
        }
        if (!s) throw r;
      }
  ...
  class I extends U {
    ...
    constructor(e = {}) {
      (super(e),
        this.plugins.some((e) => 'cacheWillUpdate' in e) || this.plugins.unshift(N),
    ...
    async _handle(e, t) {
      ...
      if (this._networkTimeoutSeconds) {
        let { id: i, promise: n } = this._getTimeoutPromise({ request: e, logs: s, handler: t });
        ((a = i), r.push(n));
      }
      let n = this._getNetworkPromise({ timeoutId: a, request: e, logs: s, handler: t });
      r.push(n);
      let c = await t.waitUntil((async () => (await t.waitUntil(Promise.race(r))) || (await n))());
  ...
  class L extends U {
    ...
    async _handle(e, t) {
      ...
      try {
        let a = [t.fetch(e)];
        if (this._networkTimeoutSeconds) {
          let e = n(1e3 * this._networkTimeoutSeconds);
          a.push(e);
        }
  ...
  class O {
    ...
    async setTimestamp(e, t) {
      ...
      let a = { id: this._getId(e), cacheName: this._cacheName, url: e, timestamp: t },
        s = (await this.getDb()).transaction(F, 'readwrite', { durability: 'relaxed' });
      (await s.store.put(a), await s.done);
    }
    async getTimestamp(e) {
      let t = await this.getDb(),
        a = await t.get(F, this._getId(e));
      return a?.timestamp;
    }
    async expireEntries(e, t) {
      let a = await this.getDb(),
        s = await a.transaction(F, 'readwrite').store.index('timestamp').openCursor(null, 'prev'),
        r = [],
        i = 0;
      for (; s; ) {
        let a = s.value;
    ...
    async getDb() {
      return (
        this._db ||
          (this._db = await _('serwist-expiration', 1, {
  ...
  class W {
    ...
    constructor(e = {}) {
      ...
      ((this._config = e),
        ...
        this._config.purgeOnQuotaError && ((t = () => this.deleteCacheAndMetadata()), c.add(t)));
    }
    _getCacheExpiration(e) {
      if (e === r.getRuntimeName()) throw new i('expire-custom-caches-only');
      let t = this._cacheExpirations.get(e);
      return (t || ((t = new K(e, this._config)), this._cacheExpirations.set(e, t)), t);
    }
  ...
  class j {
    cachedResponseWillBeUsed = async ({ request: e, cachedResponse: t }) =>
      t && e.headers.has('range') ? await B(e, t) : t;
  }
  class $ extends U {
    async _handle(e, t) {
      let a,
  ...
  let G = { rscPrefetch: 'pages-rsc-prefetch', rsc: 'pages-rsc', html: 'pages' },
    Q = [
      {
        matcher: /^https:\/\/fonts\.(?:gstatic)\.com\/.*/i,
        handler: new $({
          cacheName: 'google-fonts-webfonts',
          plugins: [new W({ maxEntries: 4, maxAgeSeconds: 31536e3, maxAgeFrom: 'last-used' })],
        }),
      },
      {
        ...
        handler: new H({
          ...
          plugins: [new W({ maxEntries: 4, maxAgeSeconds: 604800, maxAgeFrom: 'last-used' })],
        }),
      },
      {
      ...
      },
      {
        ...
        handler: new H({
          ...
          plugins: [new W({ maxEntries: 64, maxAgeSeconds: 2592e3, maxAgeFrom: 'last-used' })],
        }),
      },
      {
        ...
        handler: new $({
          ...
          plugins: [new W({ maxEntries: 64, maxAgeSeconds: 86400, maxAgeFrom: 'last-used' })],
        }),
      },
      {
      ...
      },
      {
        ...
        handler: new $({
          ...
          plugins: [
            new W({ maxEntries: 32, maxAgeSeconds: 86400, maxAgeFrom: 'last-used' }),
            new j(),
          ],
        }),
      },
      ...
      },
      {
        ...
        handler: new H({
          ...
          plugins: [new W({ maxEntries: 48, maxAgeSeconds: 86400, maxAgeFrom: 'last-used' })],
        }),
      },
      {
        matcher: /\.(?:css|less)$/i,
        handler: new H({
          ...
          plugins: [new W({ maxEntries: 32, maxAgeSeconds: 86400, maxAgeFrom: 'last-used' })],
        }),
      },
      {
      ...
      { matcher: /\/api\/auth\/.*/, handler: new L({ networkTimeoutSeconds: 10 }) },
      {
        matcher: ({ sameOrigin: e, url: { pathname: t } }) => e && t.startsWith('/api/'),
        method: 'GET',
        handler: new I({
          cacheName: 'apis',
          plugins: [new W({ maxEntries: 16, maxAgeSeconds: 86400, maxAgeFrom: 'last-used' })],
      ...
      },
      {
        matcher: ({ request: e, url: { pathname: t }, sameOrigin: a }) =>
          ...
          !t.startsWith('/api/'),
        handler: new I({
          cacheName: G.rscPrefetch,
          plugins: [new W({ maxEntries: 32, maxAgeSeconds: 86400 })],
        }),
      },
      {
        matcher: ({ request: e, url: { pathname: t }, sameOrigin: a }) =>
      ...
      },
      {
        ...
        handler: new I({
          ...
          plugins: [new W({ maxEntries: 32, maxAgeSeconds: 3600 })],
          networkTimeoutSeconds: 10,
        }),
      },
      { matcher: /.*/i, method: 'GET', handler: new L() },
    ],
    V = {
      googleAnalytics: 'googleAnalytics',
      precache: 'precache-v2',
    ...
    z = (e) => [V.prefix, e, V.suffix].filter((e) => e && e.length > 0).join('-'),
    J = {
      updateDetails: (e) => {
        var t = (t) => {
          let a = e[t];
          'string' == typeof a && (V[t] = a);
        };
        for (let e of Object.keys(V)) t(e);
      },
      getGoogleAnalyticsName: (e) => e || z(V.googleAnalytics),
      getPrecacheName: (e) => e || z(V.precache),
      getRuntimeName: (e) => e || z(V.runtime),
    };
  ...
  async function et(e, t, a, s) {
    ...
    if (t.url === r) return e.match(t, s);
    let i = { ...s, ignoreSearch: !0 };
    for (let n of await e.keys(t, i)) if (r === ee(n.url, a)) return e.match(n, s);
  }
  class ea {
    promise;
    resolve;
  ...
  let es = async () => {
    ...
    ec = async (e, t) => {
      ...
      if ((e.url && (s = new URL(e.url).origin), s !== self.location.origin))
        throw new X('cross-origin-copy-response', { origin: s });
      let r = e.clone(),
  ...
  class eh {
    _db = null;
    async addEntry(e) {
      let t = (await this.getDb()).transaction(eo, 'readwrite', { durability: 'relaxed' });
      (await t.store.add(e), await t.done);
    }
    async getFirstEntryId() {
      let e = await this.getDb(),
        t = await e.transaction(eo).store.openCursor();
      return t?.value.id;
    }
    async getAllEntriesByQueueName(e) {
      let t = await this.getDb();
      return (await t.getAllFromIndex(eo, el, IDBKeyRange.only(e))) || [];
    }
    async getEntryCountByQueueName(e) {
      return (await this.getDb()).countFromIndex(eo, el, IDBKeyRange.only(e));
    }
    async deleteEntry(e) {
      let t = await this.getDb();
      await t.delete(eo, e);
    ...
    async getEndEntryFromIndex(e, t) {
      let a = await this.getDb(),
        s = await a.transaction(eo).store.index(el).openCursor(e, t);
      return s?.value;
    }
    async getDb() {
      return (
        this._db ||
          (this._db = await _('serwist-background-sync', 3, { upgrade: this._upgradeDb })),
        this._db
      );
    }
    _upgradeDb(e, t) {
      (t > 0 && t < 3 && e.objectStoreNames.contains(eo) && e.deleteObjectStore(eo),
        e
          .createObjectStore(eo, { autoIncrement: !0, keyPath: 'id' })
          .createIndex(el, el, { unique: !1 }));
    }
  }
  class eu {
    _queueName;
    _queueDb;
    constructor(e) {
      ((this._queueName = e), (this._queueDb = new eh()));
    }
    async pushEntry(e) {
  ...
  class ef {
    ...
    clone() {
      return new ef(this.toObject());
    }
  }
  let em = 'serwist-background-sync',
    ew = new Set(),
    ep = (e) => {
      let t = { request: new ef(e.requestData).toRequest(), timestamp: e.timestamp };
  ...
  class eg {
    ...
    async getAll() {
      ...
      for (let s of e) {
        ...
        t - s.timestamp > e ? await this._queueStore.deleteEntry(s.id) : a.push(ep(s));
      }
      return a;
    }
    async size() {
    ...
    async _addRequest({ request: e, metadata: t, timestamp: a = Date.now() }, s) {
      let r = { requestData: (await ef.fromRequest(e.clone())).toObject(), timestamp: a };
    ...
    async _removeRequest(e) {
      ...
      if (t) {
        ...
        return a - t.timestamp > s ? this._removeRequest(e) : ep(t);
      }
    }
    async replayRequests() {
      ...
      for (; (e = await this.shiftRequest()); )
        try {
          ...
          throw (await this.unshiftRequest(e), new X('queue-replay-failed', { name: this._name }));
        }
    }
    async registerSync() {
      if ('sync' in self.registration && !this._forceSyncFallback)
        try {
          await self.registration.sync.register(`${em}:${this._name}`);
        } catch (e) {}
    }
    _addSyncListener() {
      'sync' in self.registration && !this._forceSyncFallback
        ? self.addEventListener('sync', (e) => {
            if (e.tag === `${em}:${this._name}`) {
              let t = async () => {
                let t;
  ...
  class ev {
    ...
    async fetch(e) {
      ...
      try {
        ...
        if (e instanceof Error)
          throw new X('plugin-error-request-will-fetch', { thrownErrorMessage: e.message });
      }
      let i = a.clone();
      try {
        let e;
    ...
    async cachePut(e, t) {
      ...
      let { cacheName: i, matchOptions: n } = this._strategy,
        ...
        l = o ? await et(c, s.clone(), ['__WB_REVISION__'], n) : null;
      try {
        await c.put(s, o ? r.clone() : r);
      } catch (e) {
        if (e instanceof Error) throw ('QuotaExceededError' === e.name && (await es()), e);
      }
      for (let e of this.iterateCallbacks('cacheDidUpdate'))
        await e({
          cacheName: i,
    ...
    async getCacheKey(e, t) {
      ...
      if (!this._cacheKeys[a]) {
        let s = e;
        for (let e of this.iterateCallbacks('cacheKeyWillBeUsed'))
          s = eb(await e({ mode: t, request: s, event: this.event, params: this.params }));
        this._cacheKeys[a] = s;
      }
      return this._cacheKeys[a];
    }
  ...
  class ex {
    ...
    matchOptions;
    constructor(e = {}) {
      ((this.cacheName = J.getRuntimeName(e.cacheName)),
        (this.plugins = e.plugins || []),
        (this.fetchOptions = e.fetchOptions),
        (this.matchOptions = e.matchOptions));
    }
  ...
  class eR extends ex {
    ...
    constructor(e = {}) {
      (super(e),
        this.plugins.some((e) => 'cacheWillUpdate' in e) || this.plugins.unshift(e_),
        (this._networkTimeoutSeconds = e.networkTimeoutSeconds || 0));
    }
    async _handle(e, t) {
      let a,
      ...
      let i = this._getNetworkPromise({ timeoutId: a, request: e, logs: s, handler: t });
      r.push(i);
      let n = await t.waitUntil((async () => (await t.waitUntil(Promise.race(r))) || (await i))());
      if (!n) throw new X('no-response', { url: e.url });
      return n;
    }
    _getTimeoutPromise({ request: e, logs: t, handler: a }) {
      let s;
  ...
  class eE extends ex {
    ...
    async _handle(e, t) {
      ...
      try {
        let a = [t.fetch(e)];
        if (this._networkTimeoutSeconds) {
          let e = Y(1e3 * this._networkTimeoutSeconds);
          a.push(e);
        }
        if (!(s = await Promise.race(a)))
          throw Error(
      ...
      if (!s) throw new X('no-response', { url: e.url, error: a });
      return s;
    }
  }
  let eq = (e) => (e && 'object' == typeof e ? e : { handle: e });
  class eS {
    handler;
    match;
    method;
    ...
    constructor(e, t, a = 'GET') {
      ((this.handler = eq(t)), (this.match = e), (this.method = a));
    }
    setCatchHandler(e) {
      this.catchHandler = eq(e);
    }
  }
  class eC extends ex {
    _fallbackToNetwork;
    ...
    static copyRedirectedCacheableResponsesPlugin = {
      cacheWillUpdate: async ({ response: e }) => (e.redirected ? await ec(e) : e),
    };
    constructor(e = {}) {
      ((e.cacheName = J.getPrecacheName(e.cacheName)),
        super(e),
        (this._fallbackToNetwork = !1 !== e.fallbackToNetwork),
        this.plugins.push(eC.copyRedirectedCacheableResponsesPlugin));
    }
    async _handle(e, t) {
    ...
    async _handleFetch(e, t) {
      ...
      if (this._fallbackToNetwork) {
        let r = s.integrity,
          i = e.integrity,
          n = !i || i === r;
        ((a = await t.fetch(new Request(e, { integrity: 'no-cors' !== e.mode ? i || r : void 0 }))),
          r &&
            n &&
            'no-cors' !== e.mode &&
            (this._useDefaultCacheabilityPluginIfNeeded(), await t.cachePut(e, a.clone())));
      } else throw new X('missing-precache-entry', { cacheName: this.cacheName, url: e.url });
      return a;
    }
    async _handleInstall(e, t) {
      ...
      if (!(await t.cachePut(e, a.clone())))
        throw new X('bad-precaching-response', { url: e.url, status: a.status });
      return a;
    }
    _useDefaultCacheabilityPluginIfNeeded() {
      ...
      for (let [a, s] of this.plugins.entries())
        s !== eC.copyRedirectedCacheableResponsesPlugin &&
          (s === eC.defaultPrecacheCacheabilityPlugin && (e = a), s.cacheWillUpdate && t++);
      0 === t
        ? this.plugins.push(eC.defaultPrecacheCacheabilityPlugin)
  ...
  let eP = (e) => {
    ...
    if (!a) throw new X('add-to-cache-list-unexpected-type', { entry: e });
    if (!t) {
  ...
  'undefined' != typeof navigator && /^((?!chrome|android).)*safari/i.test(navigator.userAgent);
  let eA = 'www.google-analytics.com',
    eU = 'www.googletagmanager.com',
    eI = /^\/(\w+\/)?collect/,
    eL = ({ serwist: e, cacheName: t, ...a }) => {
      let s = J.getGoogleAnalyticsName(t),
        r = new ey('serwist-google-analytics', {
      ...
      for (let t of [
        ...
        new eS(
          ({ url: e }) => e.hostname === eA && '/analytics.js' === e.pathname,
          new eR({ cacheName: s }),
          'GET'
        ),
        new eS(
        ...
        ...((e) => {
          let t = ({ url: e }) => e.hostname === eA && eI.test(e.pathname),
            a = new eE({ plugins: [e] });
          return [new eS(t, a, 'GET'), new eS(t, a, 'POST')];
        })(r),
      ])
        e.registerRoute(t);
    };
  ...
  class eK {
    ...
    constructor({
      ...
      let {
        ...
        return {
          precacheStrategyOptions: {
            cacheName: J.getPrecacheName(a),
            plugins: [...s, new eO({ precacheController: e })],
            fetchOptions: r,
            matchOptions: i,
            fallbackToNetwork: n,
          },
      ...
      if (
        ...
        (this._precacheStrategy = new eC(m)),
        ...
        void 0 !== i && ((d = { prefix: i }), J.updateDetails(d)),
        a
          ? self.skipWaiting()
          : self.addEventListener('message', (e) => {
              e.data && 'SKIP_WAITING' === e.data.type && self.skipWaiting();
            }),
        n && self.addEventListener('activate', () => self.clients.claim()),
        e && e.length > 0 && this.addToPrecacheList(e),
        p.cleanupOutdatedCaches &&
          ((f = m.cacheName),
          self.addEventListener('activate', (e) => {
            e.waitUntil(ei(J.getPrecacheName(f)).then((e) => {}));
          })),
        this.registerRoute(new eM(this, w)),
        p.navigateFallback &&
          this.registerRoute(
            new eD(this.createHandlerBoundToUrl(p.navigateFallback), {
              allowlist: p.navigateFallbackAllowlist,
              denylist: p.navigateFallbackDenylist,
            })
          ),
        void 0 !== o &&
          ('boolean' == typeof o ? o && eL({ serwist: this }) : eL({ ...o, serwist: this })),
        void 0 !== c)
      ) {
        if (void 0 !== h) {
          let e = new eF({ fallbackUrls: h.entries, serwist: this });
          c.forEach((t) => {
            t.handler instanceof ex &&
      ...
      l && (self.__WB_DISABLE_DEV_LOGS = !0);
    }
      ...
      for (let a of e) {
        ...
        if ('string' != typeof a && a.integrity) {
          if (
            ...
            throw new X('add-to-cache-list-conflicting-integrities', { url: s });
...
This is generally NOT safe. Learn more at https://bit.ly/wb-precache`);
    ...
    setDefaultHandler(e, t = 'GET') {
      this._defaultHandlerMap.set(t, eq(e));
    }
    setCatchHandler(e) {
      this._catchHandler = eq(e);
    }
    registerCapture(e, t, a) {
      let s = ((e, t, a) => {
        ...
        if (e instanceof RegExp) return new ek(e, t, a);
    ...
    unregisterRoute(e) {
      if (!this._routes.has(e.method))
        throw new X('unregister-route-but-not-found-with-method', { method: e.method });
      let t = this._routes.get(e.method).indexOf(e);
      if (t > -1) this._routes.get(e.method).splice(t, 1);
      else throw new X('unregister-route-route-not-registered');
    }
  ...
  new eK({
    precacheEntries: [
      {
        revision: '0a45857058cea672e727ec47ab62b753',
        url: '/_next/static/B0RdMgyqbndSbt4STA2PX/_buildManifest.js',
      },
      {
        revision: 'b6652df95db52feb4daf4eca35380933',
        url: '/_next/static/B0RdMgyqbndSbt4STA2PX/_ssgManifest.js',
      },
      { revision: null, url: '/_next/static/chunks/130-65d0a99c21ae69c6.js' },
      { revision: null, url: '/_next/static/chunks/393-b97efd68d5270de8.js' },
      { revision: null, url: '/_next/static/chunks/app/%5Blocale%5D/layout-3c09d31ab5d70c18.js' },
      { revision: null, url: '/_next/static/chunks/app/%5Blocale%5D/page-655d04f87b2fb116.js' },
      {
        revision: null,
        url: '/_next/static/chunks/app/%5Blocale%5D/pricing/page-72fb717ccd44c742.js',
      },
      {
        revision: null,
        url: '/_next/static/chunks/app/%5Blocale%5D/tools/hand-rankings/page-7f12a2204a10da98.js',
      },
      {
        revision: null,
        url: '/_next/static/chunks/app/%5Blocale%5D/tools/icm/page-8b9fa6e12c22aa6a.js',
      },
      {
        revision: null,
        url: '/_next/static/chunks/app/%5Blocale%5D/tools/layout-13f3be97476c3a11.js',
      },
      {
        revision: null,
        url: '/_next/static/chunks/app/%5Blocale%5D/tools/pot-odds/page-a118e03d78bfdec8.js',
      },
      {
        revision: null,
        url: '/_next/static/chunks/app/%5Blocale%5D/tools/push-fold/page-f4e93544a4b2ea45.js',
      },
      {
        revision: null,
        url: '/_next/static/chunks/app/%5Blocale%5D/~offline/page-72fb717ccd44c742.js',
      },
      { revision: null, url: '/_next/static/chunks/app/_not-found/page-63346170d754ed88.js' },
      { revision: null, url: '/_next/static/chunks/app/api/health/route-842e170eecdf36e4.js' },
      { revision: null, url: '/_next/static/chunks/app/layout-842e170eecdf36e4.js' },
      { revision: null, url: '/_next/static/chunks/b119d164-acfdc2c5bf3a100b.js' },
      { revision: null, url: '/_next/static/chunks/framework-5745246463d922f1.js' },
      { revision: null, url: '/_next/static/chunks/main-051ab6b0883fb7dc.js' },
      { revision: null, url: '/_next/static/chunks/main-app-21ef43ecc6e77a24.js' },
      { revision: null, url: '/_next/static/chunks/pages/_app-9f02a757bdba10a1.js' },
      { revision: null, url: '/_next/static/chunks/pages/_error-ea3f9ff94e859035.js' },
      {
        revision: '846118c33b2c0e922d7b3a7676f81f6f',
        url: '/_next/static/chunks/polyfills-42372ed130431b0a.js',
      },
      { revision: null, url: '/_next/static/chunks/webpack-3f4bfb2b0378bccc.js' },
      { revision: null, url: '/_next/static/css/da32ea87115a4869.css' },
      { revision: '97511ebf2da463df5102d05d192a930b', url: '/icons/icon-192.png' },
      { revision: '8386bfcf94ea53f9c79ba6c3661148e3', url: '/icons/icon-512.png' },
      { revision: 'be1c22423c4d03b740c344e7774da365', url: '/manifest.json' },
    ],
    skipWaiting: !0,
    clientsClaim: !0,
    navigationPreload: !0,
