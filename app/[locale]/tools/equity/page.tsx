...
import { EquityCalc } from '@/components/tools/EquityCalc';
...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  const t = await getTranslations({ locale, namespace: 'tools.equity' });
...
export default async function EquityPage() {
  const t = await getTranslations('tools.equity');
